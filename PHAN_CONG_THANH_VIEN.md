...
| 5 | **Nguyễn An Khả** | Chuyên viên Dữ liệu & QA | Module `tests/` (5 files test) | Viết test cases (>100 cases), kiểm thử tự động, tạo Ground Truth, đánh giá Accuracy |
| 6 | **Nguyễn Gia Quý** | Tools Debug & Báo cáo | Module `tools/` (6 files Python) + Tài liệu | Phát triển tools debug/automation, Jupyter Notebook demo, tài liệu kỹ thuật, báo cáo khoa học |
