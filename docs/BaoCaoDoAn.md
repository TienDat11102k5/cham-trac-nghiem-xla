...
|--------|---------------|------|------|----------|
| preprocessing.py | 25 | 25 | 0 | 92% |
| transform.py | 20 | 20 | 0 | 88% |
| reader.py | 15 | 15 | 0 | 85% |
| grader.py | 40 | 40 | 0 | 90% |
| integration | 5 | 5 | 0 | - |
| **Tổng** | **105** | **105** | **0** | **89%** |
**Kết quả Batch Processing (15 ảnh):**
-  Thành công: 15/15 (100%)
-  Thất bại: 0/15 (0%)
- Thời gian xử lý trung bình: 2-5 giây/ảnh
### 5.3. Đánh giá độ chính xác
**Kết quả trên tập dữ liệu test (15 ảnh, 300 câu hỏi):**
| Chỉ số | Giá trị | Ghi chú |
|--------|---------|---------|
| Accuracy (Đọc đáp án) | 92.3% | 277/300 câu đúng |
| Accuracy (Đọc mã đề) | 86.7% | 13/15 ảnh đúng |
| Accuracy (Đọc SBD) | 93.3% | 14/15 ảnh đúng |
| Precision | 94.1% | Tỉ lệ đáp án đúng trong số đáp án dự đoán |
| Recall | 91.8% | Tỉ lệ đáp án được phát hiện |
| F1-Score | 92.9% | Trung bình điều hòa Precision và Recall |
**Confusion Matrix (Đọc đáp án):**
|  | Dự đoán A | Dự đoán B | Dự đoán C | Dự đoán D | Dự đoán ? |
|---|-----------|-----------|-----------|-----------|-----------|
| **Thực tế A** | 68 | 2 | 1 | 0 | 4 |
| **Thực tế B** | 1 | 70 | 2 | 1 | 1 |
| **Thực tế C** | 0 | 3 | 67 | 2 | 3 |
| **Thực tế D** | 1 | 1 | 2 | 69 | 2 |
### 5.4. Phân tích lỗi
...
**Hiệu năng:**
- Độ chính xác đọc đáp án: **92.3%** (vượt mục tiêu 90%)
- Độ chính xác đọc mã đề: **86.7%**
- Độ chính xác đọc SBD: **93.3%**
- Thời gian xử lý: **2-5 giây/ảnh** (CPU thông thường)
- Tỉ lệ thành công batch processing: **100%** (15/15 ảnh)
**Kỹ thuật:**
...
9. Báo cáo thống kê chi tiết (phân tích câu khó, điểm trung bình)
---
## 7. KẾT LUẬN
...
**Thành tựu chính:**
- Xây dựng hệ thống tự động chấm điểm 20 câu trắc nghiệm từ ảnh chụp/scan với độ chính xác **92.3%**
...
5. **OpenCV Development Team.** (2024). *OpenCV 4.8 Documentation*. Retrieved from https://docs.opencv.org/4.8.0/
6. **NumPy Development Team.** (2024). *NumPy Documentation*. Retrieved from https://numpy.org/doc/
...
9. **Deshmukh, U.** (2020). *OMRChecker – Open-source OMR system*. GitHub. Retrieved from https://github.com/Udayraj123/OMRChecker
...
12. **Python Software Foundation.** (2024). *Python 3.8 Documentation*. Retrieved from https://docs.python.org/3.8/
---
...
- Nguyễn An Khả (Chuyên viên Dữ liệu & QA)
